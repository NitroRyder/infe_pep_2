...
modelo_prueba <- lm (hp ~ cyl + vs + am + gear + carb, data = datos)
```
...
```{r}
str(datos[, c("cyl", "vs", "am", "gear", "carb")])
```
...
```{r}
apply(datos[, c("cyl", "vs", "am", "gear", "carb")], 2, var)
```
...
```{r}
# GRAFICO DE RECIDUOS:
residualPlots(modelo_prueba, terms = ~ cyl + vs + am + gear + carb,
              id = list(method = "r", n = 3, cex = 0.7, location = "lr"),
              col = "steelblue", pch = 19, col.quad = "red")

# GRAFICO MARGINALES:
marginalModelPlots(modelo_prueba, sd = TRUE, terms = ~ cyl + vs + am + gear + carb,
                   id = list(method = "r", n = 3, cex = 0.7, location = "lr"),
